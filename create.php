                ...
                <form method="POST" id="createForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="content" name="content" rows="8"
                                  ...
                                  placeholder="Write your amazing content here..."><?= isset($_POST['content']) ? htmlspecialchars($_POST['content']) : '' ?></textarea>
                        <div class="form-text">Content must be at least 10 characters.</div>
                    </div>
                    
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="index.php" class="btn btn-secondary me-md-2">Cancel</a>
                        <button type="submit" class="btn btn-gradient">✅ Publish Post</button>
                    </div>
                </form>
            </div>
        </div>
